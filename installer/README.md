...
## ภาพรวมระบบ
ID Bridge เป็นโปรแกรมที่ทำงานอยู่เบื้องหลังผ่านช่องทาง Local HTTP API สำหรับเชื่อมต่อเครื่องอ่านบัตรประชาชน (Smart Card Reader) 
...
### หากมีการย้ายโฟลเดอร์โปรแกรมให้ทำการรันไฟล์ setup.bat อีกครั้ง 
