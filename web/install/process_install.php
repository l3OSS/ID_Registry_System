...
try {
    ...
    echo "<p>1. ไฟล์ <b>.env</b> ถูกสร้างขึ้นที่ Root Directory (กรุณาอย่าลบทิ้งและห้ามนำขึ้น Git)</p>";
    echo "<p>2. ระบบใช้ไฟล์ <b>core/security.php</b> ในการจัดการเข้ารหัสอัตโนมัติ</p>";
    echo "<p>3. กรุณาลบโฟลเดอร์ <b>/install</b> ออกจาก Server ทันที</p>";
    echo "</div>";
