            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                        ...
                        if (userCan('users.view') || userCan('settings.manage') || userCan('logs.view') || userCan('locations.manage')): ?>
                        ...
                        <?php endif; ?>
                        <?php if (userCan('locations.manage')): ?>
                            <li><a class="dropdown-item" href="index.php?page=location_manage"><i class="bi bi-diagram-3"></i> <?php echo e('nav.locations'); ?></a></li>
                        <?php endif; ?>
                        <?php endif; ?>
